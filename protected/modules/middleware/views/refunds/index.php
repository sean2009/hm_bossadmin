<h2 class="title-h4 bordBtm1">退款单列表</h2>
...
<?php foreach ($list as $v): ?>
                <tr class="order-bd">
                    ...
                    <td class="txt-center"><?php echo $v->refund_id; ?></td>
                    <td class="txt-center"><?php echo $v->refund_fee; ?></td>
                    <td class="txt-center"><?php echo $v->refund_fee; ?></td>
                    <td class="txt-center"><?php echo $v->order_status; ?></td>
