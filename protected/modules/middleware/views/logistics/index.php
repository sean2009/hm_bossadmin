<h2 class="title-h4 bordBtm1">发货单列表</h2>
...
//            array('修正', 'middleware_order_update', $this->createUrl('update'), 1),
	...
	'enableAjaxValidation'=>false,
            ...
            渠道真实订单号<?php echo $form->textField($model,'tid',array('class'=>'inpt','maxlength'=>30)); ?>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tables">
        <thead>
            <tr class="order-hd">
                <th width="2%">&nbsp;&nbsp;</th>
                <th width="2%">编号</th>
                <th width="10%">渠道真实订单号</th>
                <th width="3%">渠道类型</th>
                <th width="8%">物流公司</th>
                <th width="8%">物流单号</th>
                <th width="4%">是否同步</th>
                <th width="4%">渠道同步时间</th>
            </tr>
        </thead>
        <tbody>
<?php foreach ($list as $v): ?>
                <tr class="order-bd">
                    ...
                    <td class="txt-center"><?php echo $v->channel_type; ?></td>
                    <td class="txt-center"><?php echo $v->logistics_company; ?></td>
                    <td class="txt-center"><?php echo $v->logistics_id; ?></td>
                    <td class="txt-center"><?php echo $v->sys_is_send == 1 ? '是' : '否'; ?></td>
