...
/**
 * This is the model class for table "{{admin_button}}".
 *
 * The followings are the available columns in table '{{admin_button}}':
 ...
 */
class AdminButtonModel extends BaseActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return AdminButtonModel the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('action_id, is_deleted, add_admin_id, edit_admin_id', 'numerical', 'integerOnly'=>true),
			array('button_name', 'length', 'max'=>100),
			array('button_url', 'length', 'max'=>300),
			array('button_code', 'length', 'max'=>200),
			array('admin_website', 'length', 'max'=>50),
			array('add_date, edit_date, latest_time', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('button_id, button_name, button_url, button_code, action_id, admin_website, is_deleted, add_date, edit_date, add_admin_id, edit_admin_id, latest_time', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('button_code',$this->button_code,true);
